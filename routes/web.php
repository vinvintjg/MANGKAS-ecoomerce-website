...
Route::middleware('admin')->group(function () {
    ...
    Route::get('/create-shop-admin', [ShopController::class, 'getCreateShopPageAdmin'])->name('getCreateShopPageAdmin');
    Route::get('/edit-shop/{id}', [ShopController::class, 'getShopByIdAdmin'])->name('getShopByIdAdmin');
    Route::patch('/edit-shop/{id}', [ShopController::class, 'updateShop'])->name('updateShop');
...
Route::get('/mangkas-contact', function () { return view('user-contact');})->name('mangkas-contact');
